...
export const QuotationViewer: React.FC<QuotationViewerProps> = ({ quotation, onBack }) => {
        ...
        <div className="border-b-2 border-blue-600 p-8 print:p-6">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-500">
              Điện thoại: 0962.777.779 | Email: ketoan@gmail.com
            </div>
          </div>
        </div>
        ...
        <div className="p-8 print:p-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">{serviceTypeNames[quotation.service_type as keyof typeof serviceTypeNames]}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <ul className="text-sm text-gray-600 space-y-2">
              ...
              <li>• Bảo hành sơn: 5 năm đối với lỗi kỹ thuật</li>
          ...
          <div className="flex justify-between items-end pt-8 border-t border-gray-200">
            <div className="text-center">
              <div className="text-sm text-gray-600 mb-16">Ngày lập: {formatDate(quotation.created_at || '')}</div>
